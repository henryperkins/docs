...
try:
    ...
    if not os.path.exists(LIB_PATH):
        logger.info(f"Building Tree-sitter library at '{LIB_PATH}'...")
        ...
        logger.info("Tree-sitter library built successfully.")
    else:
        logger.info(f"Tree-sitter library already exists at '{LIB_PATH}'.")
...
try:
    ...
    logger.info("Initialized Tree-sitter parsers.")
...
def insert_js_ts_docstrings(docstrings: Dict) -> str:
    ...
    Args:
        docstrings: The docstrings to insert, including AST and source code.

    Returns:
        The modified JS/TS code with inserted docstrings.
    """
    try:
