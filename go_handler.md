...
## Overview
**File:** `docs/language_functions/go_handler.py`
**Description:** 
...
|-------|---------------|-------------------|
| `GoHandler` | `BaseHandler` | 0 |

### Class Methods

| Class | Method | Parameters | Returns | Complexity Score* |
|-------|--------|------------|---------|-------------------|
| `GoHandler` | `extract_structure` | `(self: Any, code: str, file_path: str = None)` | `Dict[(str, Any)]` | 0 |
| `GoHandler` | `insert_docstrings` | `(self: Any, code: str, documentation: Dict[(str, Any)])` | `str` | 0 |
| `GoHandler` | `validate_code` | `(self: Any, code: str, file_path: Optional[str] = None)` | `bool` | 0 |
